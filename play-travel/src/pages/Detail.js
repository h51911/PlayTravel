    ...
    async toDate(list){
       ...
       let currentdate1 = time(1);
        ...
        if(user){
            let data= {
                order_id,
                product_id:list.goodId,
                total:list.price,
                product_name:list.title,
                date_added:currentdate,
                pay_time_limit:currentdate1,
                status_id:1,
                status_name:"未支付",
                user:user.account
            }
            localStorage.setItem('data',JSON.stringify(data))
            this.props.history.push('/date/' + this.state.goodId);
        }else{
            ...
            <div className="detail">
                ...
                <div className="goods">
                    ...
                    <div className="particulars">
                            {
                                items.map(item=>(
                                    <div className="hotelContent" key={item.item_id}>
                                        {item.image_url?<div className="hotelContentImg">
                                            <img src={item.image_url} alt="" />
                                        </div>:''}
                ...
                <div className="buyNow">
                    ...
                    <div className="buy" 
                    onClick={this.toDate.bind(this,{goodId,title,price})}
                    >
                        立即购买
                    </div>
                </div>         
